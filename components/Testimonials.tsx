        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-flow-col auto-cols-[320px] sm:auto-cols-[360px] gap-8 overflow-x-auto no-scrollbar" aria-label="Testimonials">
            {visibleTestimonials.map((testimonial) => (
              <Reveal key={testimonial.id} from="up" delayMs={testimonial.id * 90}>
                <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 dark:bg-[#0b1220] dark:border dark:border-white/10 dark:shadow-black/30">
